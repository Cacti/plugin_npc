			...
			<table width="100%">
				<tr>
					...
					<td align="right">
						...
						Logged in as <strong><?php print html_escape(db_fetch_cell_prepared("select username from user_auth where id = ?", array($_SESSION["sess_user_id"])));?></strong> (<a href="<?php echo $config['url_path']; ?>logout.php">Logout</a>)&nbsp;
						<?php } ?>
					</td>
				</tr>
			</table>
